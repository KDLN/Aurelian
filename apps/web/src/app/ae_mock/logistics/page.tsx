'use client';
export default function Page(){return (<div className="ae wrap"><div className="panel left"><h1>Logistics</h1></div><div className="panel right"><div className='muted'>Mock only. Wire later.</div></div>
<style>{`
