'use client'; export default function Hub(){return (<div className='ae' style={{padding:16}}><h1>Aurelian — Mock Hub (/ae_mock)</h1><ul><li><a href='/ae_mock/auction'>Auction</a></li><li><a href='/ae_mock/logistics'>Logistics</a></li><li><a href='/ae_mock/scouts'>Scouts</a></li><li><a href='/ae_mock/crafting'>Crafting</a></li><li><a href='/ae_mock/contracts'>Contracts</a></li><li><a href='/ae_mock/insurance'>Insurance</a></li><li><a href='/ae_mock/analytics'>Analytics</a></li><li><a href='/ae_mock/guild'>Guild</a></li><li><a href='/ae_mock/events'>Events</a></li><li><a href='/ae_mock/cosmetics'>Cosmetics</a></li></ul>
<style>{`
